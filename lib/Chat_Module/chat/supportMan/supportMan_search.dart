                    ...
                    if (snapshot.connectionState == ConnectionState.active) {
                      if (snapshot.hasData) {
                        ...
                        if (dataSnapshot.docs.length > 0) {
                          ...
                          return userName == searchedUser.username
                              ? Text("No Data Found")
                              : ListTile(
                                  onTap: () async {
                                        ...
                                        child: ChatRoom(
                                          ...
                                          targetUser: MyUserModel(
                                            ...
                                            username: searchedUser.username
                                                .toString(),
                                            phone:
                                                searchedUser.phone.toString(),
                                            facebook: searchedUser.facebook
                                                .toString(),
                                            linkedIn: searchedUser.linkedIn
                                                .toString(),
                                            twitter:
                                    ...
                                    if (dataSnapshot.docs.length > 0) {
                                      ...
                                      return userName == searchedUser.username
                                          ...
                                          : ListTile(
                                                    ...
                                                    child: ChatRoom(
                                                      ...
                                                      targetUser: MyUserModel(
                                                        ...
                                                        phone: searchedUser
                                                            .phone
                                                            .toString(),
                                                        facebook: searchedUser
                                                            .facebook
                                                            .toString(),
                                                        linkedIn: searchedUser
                                                            .linkedIn
                                                            .toString(),
                                                        twitter: searchedUser
                                                            .twitter
                                                            .toString(),
                                                        dribble: searchedUser
                                                            .dribble
                                                            .toString(),
                                                        status: searchedUser
                                                            .status
                                              ...
                                              leading: Badge(
                                                shape: BadgeShape.circle,
                                                badgeColor: searchedUser.status
                                                            .toString() ==
                                                        "online"
                                                    ? Colors.green
                                                    : Colors.grey,
