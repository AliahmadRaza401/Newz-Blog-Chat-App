                ...
                icon:
                    ...
                    StreamBuilder(
                        stream: FirebaseFirestore.instance
                            ...
                            .where("idTo", isEqualTo: uid.toString())
                            // .where('count', isNotEqualTo: 0)
                        ...
                        builder: (BuildContext context,
                          ...
                          if (!snapshot.hasData) {
                            print("Has not Data__________________________");
                            // print('snapshot.data: ${snapshot.data}');

                            return Center(
                              child: Image.asset(ic_email,
                                  width: 22,
                                  height: 22,
                            ...
                            print("Has Data__________________________");
                            log("Has Data__________________________");
